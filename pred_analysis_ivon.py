...
path_out =  '/share/nas2/dmohan/bbb/RadioGalaxies-BBB/exps/ivon/exp6/vi_'
for i in range(10):
    model = Classifier_ConvBBB(input_ch, out_ch, kernel_size, prior_var, prior).to(device)
...
print("mean expected error", mean_expected_error)
# print("Std of error over seeds", mean_expected_error.std())

print("std of expected error", std_expected_error)

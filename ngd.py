...
def _single_tensor_adam(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        if capturable:
            ...
            param.addcdiv_(exp_avg_sq, torch.tensor(1.0).cuda())
        else:
            step = step_t.item()
            ...
            param.addcdiv_(exp_avg_sq, torch.tensor(1.0).cuda(), value=-step_size)
...
def _multi_tensor_adam(params: List[Tensor],
    ...
    if capturable:
        ...
        torch._foreach_addcdiv_(params, exp_avg_sq, torch.tensor(1.0).cuda())
    else:
        ...
        torch._foreach_addcdiv_(params, exp_avg_sq, torch.tensor(1.0).cuda(), step_size)